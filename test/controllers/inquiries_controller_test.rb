...
class InquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post inquiries_url, params: { inquiry: { address: @inquiry.address, contact: @inquiry.contact, email: @inquiry.email, first_name: @inquiry.first_name, last_name: @inquiry.last_name } }
    end
  ...
  test "should update inquiry" do
    patch inquiry_url(@inquiry), params: { inquiry: { address: @inquiry.address, contact: @inquiry.contact, email: @inquiry.email, first_name: @inquiry.first_name, last_name: @inquiry.last_name } }
